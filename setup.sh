...
#  Usage in Termux:
#    curl -fsSL https://raw.githubusercontent.com/YOUR_USERNAME/termux-ai-assistant/main/setup.sh | bash
# ============================================================
set -e
...
if [ -d "$INSTALL_DIR/.git" ]; then
  ...
  git clone https://github.com/YOUR_USERNAME/termux-ai-assistant.git "$INSTALL_DIR"
